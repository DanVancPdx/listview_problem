...
///
/// Modified by Dan Bare to select an image
...
class ImagePicker extends StatelessWidget {
 ...
 ImagePicker.integer({
  ...
  @required this.selectablePhotoAssets,
  @required this.selectableNames,
 ...
 final List<String> selectablePhotoAssets;
 
 final List<String> selectableNames;
 ...
 animateDecimalAndInteger(double valueToSelect) {
  ...
  animateDecimal(((valueToSelect - valueToSelect.floorToDouble()) * pow(10, decimalPlaces)).round());
 }
 ...
 Widget _integerListView(ThemeData themeData) {
  TextStyle selectedStyle = themeData.textTheme.body2.copyWith(color: themeData.accentColor);
     ...
     itemBuilder: (BuildContext context, int index) {
      ...
      return isExtra
       ...
       child: new Row(
        ...
        children: <Widget>[
         new Image.asset(
          selectablePhotoAssets[value],
          width: 30.0,
          height: 30.0,
          fit: BoxFit.scaleDown,
          alignment: FractionalOffset.center,
         ),
         new Text("    " + selectableNames[value], style: itemStyle),
        ],
       ),
      );
     },
 ...
 Widget _decimalListView(ThemeData themeData) {
  ...
  int itemCount = selectedIntValue == maxValue ? 3 : pow(10, decimalPlaces) + 2;
 ...
 double _toDecimal(int decimalValueAsInteger) {
  return double.parse((decimalValueAsInteger * pow(10, -decimalPlaces)).toStringAsFixed(decimalPlaces));
 }
...
class NumberPickerDialog extends StatefulWidget {
 final int minValue;
 final int maxValue;
 final List<String> selectableSuitcases;
 final List<String> selectableSuitcaseNames;
 final List<String> selectableSuitcaseSids;
 ...
 NumberPickerDialog.integer({
  @required this.minValue,
  @required this.maxValue,
  @required this.selectableSuitcases,
  @required this.selectableSuitcaseNames,
  @required this.selectableSuitcaseSids,
 ...
 @override
 State<NumberPickerDialog> createState() => new _NumberPickerDialogControllerState(initialIntegerValue, initialDoubleValue);
}
...
class _NumberPickerDialogControllerState extends State<NumberPickerDialog> {
 ...
 ImagePicker _buildNumberPicker() {
  return new ImagePicker.integer(
   initialValue: selectedIntValue,
   minValue: widget.minValue,
   maxValue: widget.maxValue,
   selectablePhotoAssets: widget.selectableSuitcases,
   selectableNames: widget.selectableSuitcaseNames,
 ...
 Widget build(BuildContext context) {
  return new AlertDialog(
   ...
   actions: [
    ...
    new FlatButton(onPressed: () => Navigator.of(context).pop(selectedIntValue), child: widget.confirmWidget),
   ],
  );
 }
}
